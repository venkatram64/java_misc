...
public class SchedulingTasksForFixedDelayRepeatedExecutionUsingExecutors2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ScheduledFuture<?> scheduledFuture2 = executorService.scheduleWithFixedDelay(new ScheduledTaskB(3000),4, 2, TimeUnit.SECONDS);
