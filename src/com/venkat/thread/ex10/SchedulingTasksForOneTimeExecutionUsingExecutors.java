...
public class SchedulingTasksForOneTimeExecutionUsingExecutors {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ScheduledFuture<?> scheduledFuture = executorService.schedule(new ScheduledTaskB(0),4, TimeUnit.SECONDS);

        ScheduledFuture<?> scheduledFuture2 = executorService.schedule(new CalculateTaskD(2,3,0),6, TimeUnit.SECONDS);
